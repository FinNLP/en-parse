export interface RelationshipInterface {
	0:Array<string>,				// [left,right]
	1:Array<string>,				// [leftTag,rightTag]
	2:number,						// max distance
	3:number,						// delay
	4:string,						// direction
	5:string						// label
}
...
//		Right	left 		Tokens				max distance	Delay 		Direction 	New Label 		 		Examples
	[	["NP",	"VP"], 		["",""], 			-1, 			0,			"->",		"NSUBJ"	],				// 2 3 4
	[	["NP",	"VB"], 		["",""], 			-1, 			0,			"->",		"NSUBJ"	],				// 7
	[	["WDT",	"VP"], 		["",""], 			-1, 			0,			"->",		"NSUBJ"	],				// 8
	[	["WDT",	"VB"], 		["",""], 			-1, 			0,			"->",		"NSUBJ"	],				// 10
	[	["WP",	"VP"], 		["",""], 			-1, 			0,			"->",		"NSUBJ"	],				// 9
	[	["WP",	"VB"], 		["",""], 			-1, 			0,			"->",		"NSUBJ"	],				// 11
	[	["NP",	"VBN"],		["",""],			2,				0,			"->",		"NSUBJPASS"],			// 28
	[	["WP",	"VBN"], 	["",""], 			-1, 			1,			"->",		"DOBJ"	],				//
	[	["VP",	"NP"], 		["",""], 			-1, 			0,			"<-",		"DOBJ"	],				// 2 3
	[	["VB",	"NP"], 		["",""], 			-1, 			0,			"<-",		"DOBJ"	],				// 6 7
	[	["WDT",	"VP"], 		["",""], 			-1, 			1,			"->",		"DOBJ"	],				// 
...
//		Right	left 		Tokens				max distance	Delay 		Direction 	New Label 		 		Examples
	...
	[	["JJR",	"VBN"],		["",""],			3,				0,			"->",		"ADVMOD"],				// 
	[	["ADV",	"VBN"],		["",""],			3,				0,			"->",		"ADVMOD"],				// 
	[	["ADV", "NP"],		["",""],			3,				0,			"->",		"ADVMOD"],				// 30
	[	["JJR", "PP"],		["",""],			-1,				1,			"<-",		"ADVMOD"],				// 40
	[	["VB",	"PP"],		["",""],			-1,				1,			"<-",		"ADVMOD"],				// 
	[	["VP",	"PP"],		["",""],			-1,				1,			"<-",		"ADVMOD"],				// 
	[	["VBN",	"PP"],		["",""],			-1,				1,			"<-",		"ADVMOD"],				// 
	[	["VP",	"EM"],		["",""],			-1,				0,			"<-",		"DISCOURSE"],			// 32
	[	["VB",	"EM"],		["",""],			-1,				0,			"<-",		"DISCOURSE"],			// 
